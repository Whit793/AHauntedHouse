            ...
            public static void Third() 
            {
                ...
                switch (choice)
                {
                    ...
                    case "B":
                    {
                        ...
                        Console.WriteLine("This is it, you are going to either bleed out on the old linolium, or the monster will kill you.");
                        ...
                        Console.WriteLine("The black smoke transforms into a an old man, with coke bottle glasses and a pocket protector");
                    ...
                    case "C":
                    {
                        ...
                        Console.WriteLine("'Observe my instruments of pain: geometrey, triginometry, algebra'");
                        ...
                        if (y == 13)
                        {
                            ...
                            Console.WriteLine("The monser groans, simultaneously mad that you solved it, but also glad");
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("The monster laughs, 'hahaha, pythagoreon slays another!'");
